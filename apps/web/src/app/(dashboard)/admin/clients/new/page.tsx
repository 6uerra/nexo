            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Nombre de la empresa">
                <input className="input" required value={company.tenantName}
                  onChange={(e) => setCompany({ ...company, tenantName: e.target.value })} placeholder="Flotas del Norte" />
              </Field>
              <Field label="Razón social (opcional)">
                <input className="input" value={company.legalName}
                  onChange={(e) => setCompany({ ...company, legalName: e.target.value })} placeholder="Flotas del Norte SAS" />
              </Field>
